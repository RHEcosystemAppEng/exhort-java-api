...
public class PythonEnvironmentExtension
    ...
    private PythonControllerBase pythonController = new PythonControllerTestEnv(
    ...
    public void beforeAll(ExtensionContext extensionContext) throws Exception {
        ...
        //      try (var is = getClass().getClassLoader().getResourceAsStream(String.join("/","tst_manifests", "pip",
