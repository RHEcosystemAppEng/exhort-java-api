    ...
    void test_check_image_digest() throws IOException {
        try (MockedStatic<Operations> mock = Mockito.mockStatic(Operations.class);
            ...
            mock.when(() -> Operations.runProcessGetFullOutput(
                            isNull(),
                            aryEq(new String[] {"skopeo", "inspect", "--raw", String.format("docker://%s", imageName)}),
                            isNull()))
                    .thenReturn(output);
            ...
            var expectedImageRef = new ImageRef(
                    imageName + "@sha256:06d06f15f7b641a78f2512c8817cbecaa1bf549488e273f5ac27ff1654ed33f0",
                    "linux/amd64");
