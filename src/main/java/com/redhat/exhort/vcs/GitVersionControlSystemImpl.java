...
public class GitVersionControlSystemImpl implements VersionControlSystem {
    ...
    public TagInfo getLatestTag(Path repoLocation) {
        ...
        if (Pattern.matches("^[a-f0-9]+", commitHash)) {
            ...
            String timeStampFromGit = Operations.runProcessGetOutput(
                    repoLocation, gitBinary, "show", "HEAD", "--format=%cI", "--date", "local", "--quiet");
            ...
            String resultFromInvocation = Operations.runProcessGetOutput(
                            repoLocation, gitBinary, "describe", "--abbrev=12")
                    .trim();
            ...
            if (resultFromInvocation.contains("there were unannotated tags")) {
                ...
                resultFromInvocation = Operations.runProcessGetOutput(
    ...
    public boolean isDirectoryRepo(Path repoLocation) {
        ...
        String resultFromInvocation =
                Operations.runProcessGetOutput(repoLocation, gitBinary, "rev-parse", "--is-inside-work-tree");
