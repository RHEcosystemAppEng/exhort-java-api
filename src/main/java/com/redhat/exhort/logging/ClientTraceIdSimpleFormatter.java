...
public class ClientTraceIdSimpleFormatter extends SimpleFormatter {
    ...
    public String format(LogRecord record) {
        ...
        // %s",super.format(record).trim(),RequestManager.getInstance().getTraceIdOfRequest() + System.lineSeparator());
        ...
        if (isValidJson(jsonPartOfMessage) || messageContainsOutputStructure(message)) {
            messageKeysValues.put(
                    "logMessage", "log Message Contains a structure , and it will follow after the log entry");
        } else {
